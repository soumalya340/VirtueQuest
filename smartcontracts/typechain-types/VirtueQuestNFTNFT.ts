...
export interface VirtueQuestNFTNFTInterface extends utils.Interface {
  contractName: "VirtueQuestNFTNFT";
  functions: {
    ...
    "setTokenURIByOperator(uint256,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setTokenURIByOperator",
...
export interface VirtueQuestNFTNFT extends BaseContract {
  contractName: "VirtueQuestNFTNFT";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VirtueQuestNFTNFTInterface;
